      	...
      	*********************************************************************************************************************************************************** -->
      	...
      	<section id="main-content">
        	<section class="wrapper">
          		<h3><i class="fa fa-angle-right"></i> Modificar un cliente</h3>
                  		...
                  		<div class="form-panel">
                      		...
                      		<form class="form-horizontal style-form" action="modificarCliente" method="POST">   
								<div class="form-group">
                              		...
                              		<div class="col-sm-10">
                                  		<input READONLY type="text" name="id" value="<%=cliente.getId()%>" class="form-control">
                              		</div>
                          		</div>    	  
                          		<div class="form-group">
                          		...
                          		<div class="form-group">
                              		...
                              		<div class="col-sm-10">
                                  		<input type="text" name="rol" class="form-control" value="<%=cliente.getRol()%>" required>
                              		</div>
                          		</div>
                          		<div class="form-group">
